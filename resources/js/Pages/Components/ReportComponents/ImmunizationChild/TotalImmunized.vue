...
<template>
    <div
        class="p-6 bg-white rounded-2xl shadow-2xl relative mx-auto w-full max-w-[85%] min-h-[85%] overflow-y-auto animate-fadeIn">
                    ...
                    <tbody>
                        <tr v-for="(record, index) in paginatedRecords" :key="record.id ?? index"
                            ...
                            <td class="p-3 truncate">
                                <div v-for="(vaccine, i) in record.immunization_record || []" :key="i">
