        ...
        <ul class="space-y-2 text-blue-700">
            ...
            <li>
                <a href="maternal-profiles"
                    :class="[sidebarCollapsed ? 'pointer-events-none' : '', currentRoute === 'parent/maternal-profiles' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white']"
                    class="flex items-center gap-2 px-4 py-2 transition-all duration-300 rounded group">
                    <img :class="currentRoute === 'parent/maternal-profiles' ? 'filter brightness-0 invert' : 'group-hover:filter group-hover:brightness-0 group-hover:invert'"
                        src="/storage/assets/maternal.png" alt="">
                    <span x-show="!sidebarCollapsed" class="sidebar-label">Maternal Profile</span>
                </a>
            </li>

            <li>
                <a href="child-profiles"
                    :class="[sidebarCollapsed ? 'pointer-events-none' : '', currentRoute === 'parent/child-profiles' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white']"
                    class="flex items-center gap-2 px-4 py-2 transition-all duration-300 rounded group">
                    <img :class="currentRoute === 'parent/child-profiles' ? 'filter brightness-0 invert' : 'group-hover:filter group-hover:brightness-0 group-hover:invert'"
