            ...
            <div class="space-y-2 flex flex-col h-full">
                ...
                <div class=" p-4 h-screen bg-white rounded shadow scrollable relative">
                    ...
                    <div x-show="showChildPage"
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-base font-semibold"
                                                x-text="childProfileData.child_name"></span>
                                        </div>
                                        <div class="flex flex-col">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-base font-semibold"
                                                x-text="childProfileData.civil_status"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class=" border-b border-blue-700 space-y-2 px-4 py-2">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-base font-semibold"
                                                x-text="childProfileData.father_name"></span>
                                        </div>
                                        <div class="flex flex-col">
                                            <span class="text-sm font-medium text-gray-500">Father's Occupation:</span>
                                            <span class="text-base font-semibold"
                                                x-text="childProfileData.father_occupation"></span>
                                        </div>
                                        <div class="flex flex-col">
                                            <span class="text-sm font-medium text-gray-500">Father's Educational
                                                Level:</span>
                                            <span class="text-base font-semibold"
                                                x-text="childProfileData.father_educational_level"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" space-y-2 px-4 py-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-base font-semibold"
                                            x-text="childProfileData.place_of_delivery"></span>
                                    </div>
                                    <div class="flex flex-col">
                                        <span class="text-sm font-medium text-gray-500">Birth Attendant:</span>
                                        <span class="text-base font-semibold"
                                            x-text="childProfileData.birth_attendant"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div x-show="viewAllGrowthRecord" x-data="growth()">

                            <div class=" bg-white">
                                <div>
                                    <h1 class=" text-2xl my-2">All Growth Record</h1>
                                    <h3 class=" text-green-500 text-xl">Child: Maria Dela Cruz</h3>
                                </div>
                                ...
                                <table class="table w-full">
                                    ...
                                    <tbody>
                                        <template x-for="growth in currentPageProfiles" :key="growth.id">
                                            <tr class="table-body">
                                                <td class="p-3" x-text="growth.date"></td>
                                                <td class="p-3" x-text="growth.date"></td>
                                                <td class="p-3" x-text="growth.date"></td>
                                                <td class="p-3" x-text="growth.date"></td>
                                                <td class="p-3" x-text="growth.date"></td>
